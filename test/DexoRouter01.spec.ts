...
enum RouterVersion {
  DexoRouter01 = 'DexoRouter01',
  DexoRouter02 = 'DexoRouter02'
}

describe('DexoRouter{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.DexoRouter01]: fixture.router01,
        [RouterVersion.DexoRouter02]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.DexoRouter01]: 101876,
              [RouterVersion.DexoRouter02]: 101898
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.DexoRouter01]: 138770,
              [RouterVersion.DexoRouter02]: 138770
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
